...
#    blob_connection_string: Union[str, None] = None,
#    blob_container: Union[str, None] = None,
#    blob_prefix: Union[str, None] = "", 
#):
...
#        )
#    elif blob_connection_string and blob_container:
#        logger.info("Using blob storage: %s", blob_container)
...
if __name__ == "__main__":
    ...
    if tenant_id := os.getenv("AZURE_TENANT_ID"):
        ...
        azd_credential = AzureDeveloperCliCredential(process_timeout=180)
    ...
    list_file_strategy = setup_list_file_strategy(
        ...
        blob_container=os.getenv("AZURE_BLOB_STORAGE_CONTAINER"),
    )
